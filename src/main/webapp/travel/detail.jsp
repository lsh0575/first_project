...
<style>
	...
	<form action="#">
	<fieldset>
		<h3 class="panel-body">Travel Detail</h3>
	...
	<div class="panel">
	  <div class="panel-body img_detail">
	    ...
	    <c:if test="${not empty dto.timages_2}">
	      <p><img src="/upload/${dto.timages_2}" alt="${dto.timages_2}"></p>
	    </c:if>
	    
	    <c:if test="${not empty dto.timages_3}">
	      <p><img src="/upload/${dto.timages_3}" alt="${dto.timages_3}"></p>
	    </c:if>
	  </div>
	</div>
		<div class="panel">
