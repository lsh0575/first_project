...
<%@include file= "../inc/header.jsp" %>
	<div class="container body-top">
				...
				<div class="form-group">
					...
					<label for="check3"> 사업자 이용약관 동의(필수)</label>
				</div>
				<div class="form-group text-center">
					<textarea cols="100" rows="10" readonly><%@ include file="../agree/business_term.txt" %></textarea>
				</div>
				<div class="text-center">
					<p><a href="${pageContext.request.contextPath}/business_join.acc" class="btn btn-info" id="accept" title="약관에 동의합니다">동의</a>
				</div>
				<script>
