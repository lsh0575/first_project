						...
						<tbody>
							<tr>
								...
								<td><input type="text" class="form-control"
									...
									value="${list[0].reservation_name}" readonly /></td>
							</tr>
							<tr>
								<th scope="row">휴대폰 번호</th>
								<td><input type="tel" class="form-control"
									id="telephone_number" name="telephone_number"
									value="${list[0].telephone_number}" readonly /></td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
								<td><input type="email" class="form-control" id="email"
									value="${list[0].email}" readonly /></td>
							</tr>
						</tbody>
					</table>
				</div>

				<h4 class="airS5 heading-panel">여행자정보</h4>
				<hr />
				<div class="airP5">
					<table class="table table-striped table-bordered">
						<thead>
						...
						<tbody class="airTb">
							<c:forEach var="dto" begin="0" items="${list}"
								...
								<tr>
									...
									<td class="airtdg"><input type="text" class="airgg form-control" id="gender"
										name="gender" value="${dto.passDto.gender}" readonly /></td>
									<td><input type="text" class="form-control" id="birth_date"
										name="birth_date" value="${dto.passDto.birth_date}" readonly /></td>
							</c:forEach>
						</tbody>
					</table>
					<br /> <br /> <br />
					<div class="form-group">
					<a href="${pageContext.request.contextPath}/air_usupdate_view.air?reservation_number=${param.reservation_number}" title="예약 수정" class="btn btn-primary btn-block">변경하기</a>
					</div>
					<div class='form-group'>
					<a href="${pageContext.request.contextPath}/air_usdelete_view.air?reservation_number=${param.reservation_number}" title="예약 삭제" class="btn btn-danger btn-block">삭제하기</a>
					</div>
				</div>
				<div class="form-group">
