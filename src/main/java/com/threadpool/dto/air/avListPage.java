...
public class avListPage {
	...
	private List<AviationDto> list;	//한페이지에 나타날 리스트
	private int pageStartNum;			//리스트에서 시작할 숫자

	public avListPage() { super(); }

	public avListPage(int pageStartNum, String where) {
	...
	public List<AviationDto> getList() { return list; }
	public void setList(List<AviationDto> list) { this.list = list; }
