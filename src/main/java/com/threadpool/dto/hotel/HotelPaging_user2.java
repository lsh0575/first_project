...
public class HotelPaging_user2 { // 재활용 가능
		...
		int pstartno;
		public HotelPaging_user2() { super(); }
		public HotelPaging_user2(int pstartno) {
			...
			this.list10 = dao.userListpage(pstartno);
		...
		public HotelPaging_user2(int pageTotal, int onePageLimit, int bottomPageAll, int bottomPageLimit, int bottomCurrent,
				int bottomStart, int endStart, List<HotelDtoReserve> list10, int pstartno) {
			super();
		...
		public List<HotelDtoReserve> getList10() { return list10; } public void setList10(List<HotelDtoReserve> list10) { this.list10 = list10; }
