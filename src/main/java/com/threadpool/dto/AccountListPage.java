...
public class AccountListPage {
	...
	private List<AccountDto> list;	//한페이지에 나타날 리스트
	...
	public AccountListPage(int pageStartNum, String where) {
		AccountDao dao= new AccountDao();
		listTotal=dao.listCount(where);
		onePageListCount=20;
		...
		list = dao.userList(where, pageStartNum, onePageListCount);
	...
	public List<AccountDto> getList() { return list; } public void setList(List<AccountDto> list) { this.list = list; }
